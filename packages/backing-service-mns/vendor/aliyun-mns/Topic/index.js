...
const { xmlns } = require('../common/constants');
...
module.exports = class {
  ...
  create(metaoverride, callback) {
    // CreateTopic & SetTopicAttributes(metaoverride=true)
    ...
    const { DATE, Authorization } = this.mns.authorization({
      VERB: method,
  ...
  list(headers, callback) {
    ...
    return fetchPromise(
      ...
      (json, res) => {
        ...
        return { topics, nextMarker, status: res.status };
      },
      callback,
    );
  }
